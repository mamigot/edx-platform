...
# THEME_LOCALE_PATHS contain the paths to themes locale directories e.g.
# "THEME_LOCALE_PATHS" : [
#        "/edx/src/edx-themes/conf/locale"
#    ],
THEME_LOCALE_PATHS = ENV_TOKENS.get('THEME_LOCALE_PATHS', [])

for theme_locale_path in THEME_LOCALE_PATHS:
