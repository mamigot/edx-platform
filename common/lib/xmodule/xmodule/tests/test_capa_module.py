...
class CapaModuleTest(unittest.TestCase):
    ...
    def test_demand_hint(self):
        ...
        self.assertFalse(context['demand_hint_present'])
        ...
        self.assertTrue(context['demand_hint_present'])
        self.assertEqual('hint', context['hint_notification_type'])
        self.assertEqual('question', context['hint_notification_icon'])
